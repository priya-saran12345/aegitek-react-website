...
const MilkTrailApp = () => {
  ...
  const handleDownloadApp = () => {
    // In production, this would open app store or download link
      ...
      <div className="relative min-w-full bg-gradient-to-br from-blue-50 via-white to-blue-100 overflow-hidden">
            ...
            <div className="relative lg:ml-8">
              <div className="relative">
                <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-4 shadow-2xl border border-white/20">
                  <img 
                    src="https://docstore.indusappstore.com/public/external/indus-images/preview_images/ss3_f34b0503-c47f-40d5-9c08-03eea28397dc.webp" 
        ...
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-0 left-0 w-full h-full" style={{
            backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%234F46E5' fill-opacity='0.1'%3E%3Ccircle cx='7' cy='7' r='7'/%3E%3Ccircle cx='53' cy='7' r='7'/%3E%3Ccircle cx='30' cy='30' r='7'/%3E%3Ccircle cx='7' cy='53' r='7'/%3E%3Ccircle cx='53' cy='53' r='7'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`,
          }}></div>
        </div>
      </div>
