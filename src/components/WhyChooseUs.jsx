...
                  className={`flex-shrink-0 md:flex-shrink w-full text-left p-4 transition-colors duration-200 relative group ${
                    currentIndex === index ? 'bg-sky-100' : 'hover:bg-sky-100/50'
                  }`}
                >
                  <div className={`absolute left-0 top-0 h-full w-1 bg-[#189cd2] transition-transform duration-300 ease-out ${
                    currentIndex === index ? 'scale-y-100' : 'scale-y-0'
                  }`}></div>
