...
//     import { MapPin, Phone, Mail, Clock, Facebook, Twitter, Linkedin, Instagram, Send, ChevronUp } from 'lucide-react';
...
//     return (
//         <footer className="relative py-16 px-6 bg-slate-100 overflow-hidden">
//         {/* Custom Background Image */}
//         <div 
//             className="absolute inset-0 opacity-90 bg-cover bg-center bg-no-repeat"
//                 // style={{
//                 // opacity: 0.35,
//                 // backgroundImage: url("../src/assets/footer-img.avif"),
//                 // }}
//         ></div>
...
//         {/* pattern= absolute inset-0 bg-gradient-to-br from-slate-100/80 via-slate-100/60 to-slate-200/80 */}
//         <div className=""></div>
...
//                 <li>
//                     <a href="#" className="text-gray-600 hover:text-blue-400 transition-colors">
//                     SAP S/4HANA Consultation & Implementation
//                     </a>
//                 </li>
//                 </ul>
//             </div>
...
//                 <p className="text-gray-600 leading-relaxed">
//                 Stay updated with our latest technology insights, industry trends, 
//                 and innovative solutions delivered to your inbox.
//                 </p>
//                 <div className="space-y-4">
...
//                     className="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-300 transition-all duration-200 group-hover:border-blue-300"
//                     />
//                 </div>
//                 <button
//                 style={{ backgroundImage: 'linear-gradient(250deg, #4e95ed, #189cd2)' }}
//                     onClick={handleNewsletterSubmit}
//                     className="w-full text-white py-3 px-6 rounded-lg flex items-center justify-center space-x-2 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
//                 >
...
//                 <a href="#" className="text-gray-600 hover:text-blue-400 text-sm transition-colors">
//                     Home
//                 </a>
